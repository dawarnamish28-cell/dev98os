  ...
  return (
    <div className="flex flex-col h-full bg-[#c0c0c0]">
      ...
      <div className="flex items-center gap-1 p-1 border-b border-b-[#808080]">
        <button className="win98-btn text-[11px] h-[22px]" onClick={handleFormat}>
          Format
        </button>

        <button className="win98-btn text-[11px] h-[22px]" onClick={handleMinify}>
          Minify
        </button>

        <button className="win98-btn text-[11px] h-[22px]" onClick={handleClear}>
          Clear
        </button>
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col p-1">
          ...
          <div className="win98-border-field bg-white flex-1 overflow-auto p-1">
            {error ? (
              <div className="text-red-700 text-[11px] font-mono p-1">
                {error}
              </div>
            ) : formatted ? (
              <pre
              ...
              <div className="text-[#808080] text-[11px] p-1">
